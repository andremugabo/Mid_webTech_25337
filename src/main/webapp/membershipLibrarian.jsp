...
<main>
    ...
    <div id="membershipModal" class="modal">
        <div class="modal-content">
            <span class="close-button" onclick="document.getElementById('membershipModal').style.display='none'">
                &times;
            </span>
            ...
            <form action="membership" method="POST">
                ...
                <input type="date" id="registrationDate" name="registrationDate" value="${currentDate}" required>
        ...
        <tbody>
            <c:forEach var="membership" items="${membershipsList}">
                <tr>
                    ...
                    <td><c:out value="${membership.reader.firstName}" /> <c:out value="${membership.reader.lastName}" /></td>
                    <td>
                        <a href="librarianMembership?action=edit&membershipId=${membership.membershipId}" class="action-link">Approve</a>|
                        <a href="librarianMembership?action=delete&membershipId=${membership.membershipId}" class="action-link-delete">Reject</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
